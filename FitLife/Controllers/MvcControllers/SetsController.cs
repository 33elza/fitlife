...
namespace FitLife.Controllers.MvcControllers
{
    public class SetsController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "ID,Weight,Quantity,Time,Description,WorkoutID,ResultID")] Set set, int workoutID)
        {
            set.WorkoutID = workoutID;
            set.Workout = await db.Workouts.FindAsync(workoutID);
            var result = CreateResult(set);
